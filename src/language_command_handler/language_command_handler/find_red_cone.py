...
class FindCone(Node):
    def __init__(self, target_label: str = DEFAULT_LABEL, node_name: str = "find_red_cone") -> None:
        ...
        qos_goal = QoSProfile(depth=1, reliability=ReliabilityPolicy.RELIABLE, durability=DurabilityPolicy.TRANSIENT_LOCAL)
